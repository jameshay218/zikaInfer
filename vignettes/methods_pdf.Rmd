...
2. By fixing some of the model parameters based on the literature (Table S3), we can infer values for the basic reproductive number, $R_0$, and the epidemic seed time, $t_0$. 
