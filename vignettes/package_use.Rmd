...
res <- read_and_check(dir, parTab, mcmcPars["adaptive_period"])
print(res)
```
...
indiv_model_fit("sim_microDat.csv","sim_incDat.csv", "bahia","Simulated data",0.015,200,0.01, 730, FALSE, TRUE, parTab, chain, FALSE, FALSE)
```
