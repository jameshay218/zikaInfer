...
**Table 1: Summary of datasets included in the analysis.** *For each location, the type of incidence data, the time resolution of reports, whether or not data were extracted using a digitiser and the data source are provided. Sources refer to references in the main text.*
\tiny
```{r, echo=FALSE}
...
## Vital statistics
**Table 3. Summary of vital statistics and sources.** *Sources refer to references in the main text*
\small
```{r, echo=FALSE}
