...
Where $t_{peak}$ is the model generated ZIKV peak incidence time in a particular location; $a$ is the peak time of the ZIKV epidemic in that location based on the day of maximum reported ZIVK incidence; and $b$ is the width of the uniform window around this peak time, representing uncertainty in the timing of the peak. Here, we chose $b$ to be 60 days to represent a ~2 month window of uncertainty around the timing of the ZIKV epidemic peak.
