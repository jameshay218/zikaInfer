...
## This script produces Figure 5 from the manuscript.
...
chainWD <- "/media/james/JH USB/zika/forecast_all/"
parTab <- read.csv("~/Documents/Zika/zikaInfer/scripts/job_submissions/inputs/parTab_fixed_switch_early.csv",stringsAsFactors=FALSE)
