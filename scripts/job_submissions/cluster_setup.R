...
src <- provisionr::package_sources(local = c("~/Documents/Zika/zikaProj", "~/Documents/R_Packages/lazymcmc","~/src/rlsoda"))
sources <- c("scripts/model_fitting_script.R","scripts/model_forecasting.R")
## Setup contexts
context::context_log_start()
root <- "contexts_test"         
ctx <- context::context_save(packages=c("zikaProj","lazymcmc","plyr"), path=root, sources=sources,package_sources=src)
