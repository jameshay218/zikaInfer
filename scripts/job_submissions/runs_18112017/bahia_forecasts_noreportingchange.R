...
combos <- expand.grid(runName = "bahia_forecast_noreportingchange",chainNo=1:maxChain,stringsAsFactors=FALSE)
jobs_bahia_forecastsB <- queuer::enqueue_bulk(obj1,combos,"model_forecasting",
                                             microDat=microDat,
                                             incDat=incDat,
                                             parTab=parTab,
                                             mcmcPars1=mcmcPars1,
