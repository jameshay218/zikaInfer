...
generate_probM_forecast_NEW <- function(riskI, probM, bp, abortion_rate, birth_reduction, switch_t, abortion_time, ABORTED) {
    .Call('zikaProj_generate_probM_forecast_NEW', PACKAGE = 'zikaProj', riskI, probM, bp, abortion_rate, birth_reduction, switch_t, abortion_time, ABORTED)
}
...
generate_probM_forecast_OLD <- function(riskI, probM, bp, abortion_rate, birth_reduction, switch_t, abortion_time) {
    .Call('zikaProj_generate_probM_forecast_OLD', PACKAGE = 'zikaProj', riskI, probM, bp, abortion_rate, birth_reduction, switch_t, abortion_time)
}
